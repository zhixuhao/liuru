												...
												'</tpl>',
												 '<tpl if="EventType == \'SD\'">', 
													'<div class = "sch-event-header">',
														...
														'{Title}',
													'</div>',
													'<div class = "sch-event-header">\u65f6\u95f4\uff1a {[Ext.Date.format(values.StartDate, "H:i")]} -> {[Ext.Date.format(values.EndDate, "H:i")]}</div>',
												 '</tpl>',
												 '<tpl if="EventType == \'NW\'">', 
													'<div class = "sch-event-header">',
														'{Title}',
													'</div>',
													'<div class = "sch-event-header">\u65f6\u95f4\uff1a {[Ext.Date.format(values.StartDate, "Y-m-d H:i")]} -> {[Ext.Date.format(values.EndDate, "Y-m-d H:i")]}</div>',
												 '</tpl>'
												 ),
            ...
            tbar : [
	            ...
	            },
                {
                    ...
                    handler : function() {
                    	...
                    	var end = Ext.Date.add(start,Ext.Date.DAY,10);
