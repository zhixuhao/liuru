				...
				Ext.apply(this, {
							store : new Ext.data.JsonStore({
								model : Ext.define("UnplannedTask", {
									...
									fields : ['Name','ReleaseDate','OriginalStartDateTime','OriginalEndDateTime','OriginalDueDateTime','DueDate','DueTime','Family','SubFamily','Duration','RemainQuantity','Item','ItemDescription','WorkCenter','ParentViewStr','ChildViewStr','Priority']
								}),
	    						autoLoad:false
					    	}),
							columns : [{
            	...
            	},
                {
            		...
            		tbar : [
						'->',
						{
							...
							handler         : function() {
								var url = "./kanban.html";						
								var kanbanWin =  new Ext.Window({
									layout : 'fit',
									title : 'eHeijunka Kanban',
									closeAction : 'close',
									maximizable : true,
									autoScroll : false,
									width : 900,
									height : 600,
									html:'<iframe FRAMEBORDER ="no" src="'+url+'" width="100%" height="100%" frameborder="0" scrolling="false"></iframe>'  					
								});
								kanbanWin.show();
								kanbanWin.maximize();
							}
