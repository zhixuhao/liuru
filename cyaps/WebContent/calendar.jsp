...
<body>
	...
	<br>
	<br>
	<div class="am-u-lg-10 am-u-sm-centered" id = "calendar_editid" style="display:none;padding-top:50px">
...
function init_cal(code){
	$('#calendar_editid')[0].style.display = 'block';
...
function menuclick(id){
  ...
  function delete_click(action,cal) {  
	  $('#calendar_editid')[0].style.display = 'none';
  	  var jsondata = {};
